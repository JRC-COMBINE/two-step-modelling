function [ model_test, modelb_test, teststats, auc ] = test_model_linreg( coeffs, model_test, cutoff, responseb_test, normfunction )

% Run the model on the test set

model_test = model_test * coeffs( 2:length( coeffs ) ) + coeffs( 1 ); 
