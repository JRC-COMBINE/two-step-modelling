function [ model_test, modelb_test, teststats, auc ] = test_model_svm( model, model_test, responseb_test, cutoff, normfunction )
...
if sum(  modelb_test == 1 ) > 1 && sum( modelb_test == 0 ) > 1 
