function [ model_test, modelb_test, teststats, auc ] = test_model_log( coefficients, model_test, responseb_test, cutoff, normfunction )

% Run the model on the test set

model_test = glmval( coefficients, model_test, 'logit' );
