function [ modelfun3, model3, model3b, cutoff3, modelstats3, auc3 ] = methmodel( response_training, clustdata_training )
...
model3 = clustmean( clustdata_training, 1 );

modelfun3 = @(x) clustmean( x, 1 );


% Binarize results

modelstats3 = zeros( 5, 101 );
index = isnan( model3 ); 
