function [ modelfun2, model2, model2b, cutoff2, modelstats2, auc2 ] = CNVmodel( response_training, clustdata_training )
...
model2 = clustmean( clustdata_training, 1 );

modelfun2 = @(x) clustmean( x, 1 );


% Binarize results

modelstats2 = zeros( 5, 101 );
index = isnan( model2 );
