function [ modelfun1, model1, model1b, cutoff1, modelstats1, auc1 ] = mutmodel( response_training, clustdata_training )
...
model1 = clustmean( clustdata_training, 1 );

modelfun1 = @(x) clustmean( x, 1 );
